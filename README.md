...
* IPA_Downloader (полная версия, работает после входа с Аккаунтом Apple);
* IPA_Installer (ограниченная версия с проверкой минимальной версии iOS и установкой приложений, работает без входа с Аккаунтом Apple);
* Нажимаем Enter.
...
* При наличии обновления выбираем, перейти на GitHub для загрузки новой версии скрипта или продолжить работу с текущей версией;
* Нажимаем Enter.
#### 5. Выбираем один из доступных режимов:
* IPA_Downloader (полная версия, работает после входа с Аккаунтом Apple);
* IPA_Installer (ограниченная версия с проверкой минимальной версии iOS и установкой приложений, работает без входа с Аккаунтом Apple);
* Нажимаем Enter.
#### 6. Если выбран режим IPA_Downloader, то далее:
* Выбираем версию ipatool (по умолчанию v2, если v2 не работает, то выбираем v3);
* Нажимаем Enter;
* Вводим Аккаунт Apple (Enter email:);
* Нажимаем Enter;
...
* Вводим необходимую команду;
* Нажимаем Enter.
#### 6.1. Если выбран режим IPA_Installer, то далее:
* Вводим необходимую команду;
* Нажимаем Enter.
