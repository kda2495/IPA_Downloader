...
• Для загрузки введите ID приложения  
...
• Для загрузки введите порядковые номера версий (поддерживается ввод нескольких версий, например: 1, 2, 3-5)  
...
• Скрипт запросит список для загрузки  
• Отобразится выбранный список приложений  
• Для загрузки введите порядковые номера приложений (поддерживается ввод нескольких приложений, например: 1, 2, 3-5)  

#### 5. Вывод списка ID приложений и загрузка (с выбором версии)
• Скрипт запросит список для загрузки  
• Отобразится выбранный список приложений  
• Введите порядковые номера приложений (поддерживается ввод нескольких приложений, например: 1, 2, 3-5)  
• Скрипт запросит количество версий приложения для отображения  
• Скрипт отобразит список версий приложения для загрузки (от новой к старой)  
• Для загрузки введите порядковые номера версий (поддерживается ввод нескольких версий, например: 1, 2, 3-5)  
...
• Скрипт запросит список для загрузки  
• Отобразится выбранный список приложений  
• Для покупки введите порядковые номера приложений (поддерживается ввод нескольких приложений, например: 1, 2, 3-5)  
...
• Список ранее приобретенных приложений  
