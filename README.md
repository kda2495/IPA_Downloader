...
* Выбираем версию ipatool;
* Нажимаем Enter;
* Вводим Apple ID (Enter email:);
* Нажимаем Enter;
* Вводим пароль (Enter password:);
* Нажимаем Enter;
* На устройстве нажимаем Разрешить и запоминаем код двухфакторной аутентификации;
...
* Нажимаем Enter.
* При использовании ipatool v3 на macOS для получения кода двухфакторной аутентификации необходимо ввести устройство в авиарежим, перейти в Настройки-Ваш аккаунт-Вход и безопасность-Получить код проверки;
* При использовании ipatool v3 на macOS есть баг: в список устройств учетной записи добавляется неизвестный MacBook Pro (связано с работой anisette), при необходимости его можно удалить из списка устройств, но придется заново получить код двухфакторной аутентификации;
