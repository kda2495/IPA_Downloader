...
* Вводим пароль (Enter password:);
* Нажимаем Enter;
* Получаем код двухфакторной аутентификации (ввести устройство в режим полета, зайти в Настройки-Ваш аккаунт-Вход и безопасность-Получить код проверки;
* Вводим код двухфакторной аутентификации (Enter 2FA code:);
* Нажимаем Enter;
* Вводим необходимую команду;
* Нажимаем Enter.
...
* Нажимаем Enter.
* На версии ipatool v3 для macOS есть баг: в список устройств учетной записи добавляется неизвестный MacBook Pro (связано с работой anisette), при необходимости его можно удалить из списка устройств, но придется заново получить код двухфакторной аутентификации.
