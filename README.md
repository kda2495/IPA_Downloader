...
• Вывод списка ID приложений и покупка (без загрузки)  
...
## Как использовать:
1\. Распаковать архив любым архиватором  
2\. Дважды кликнуть по файлу `Start_IPA_Downloader.bat`  
3\. При первом запуске потребуется вход в Apple ID:  
• Ввести Apple ID (Enter email)  
• Пароль (Enter password)  
• Код двухфакторной аутентификации (Enter 2FA code)  
4\. Ввести необходимую команду  
